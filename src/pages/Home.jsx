...
const Home = () => {
            ...
            <div className='bloc__B picture'>
                <div className='caroussel'>
                    ...
                    <img
                        ...
                        src={`/img/marion_0${valueCaroussel}.png`}
    ...
    const contenuA = () => {
        ...
        <div className='intro__container'>
            ...
            <div className='bloc__intitule'>
                <img src='./img/no-picture.png' alt='graphiste - webdesigner'/>
    ...
    const contenuI = () => {
        ...
        <div className='contact__container'>
            <img src="./img/rectangle.png" alt='travaillons enssemble' />
